...
#
#
export DFCD00=0.0000
export DFCD01=0.0000
export DFCD11=0.1000
export DFCD05=0.0000
...
export DRCD51=0.100
export DRCD55=0.100
export DFCO00=0.0000
export DFCO01=0.0000
export DFCO11=0.1000
export DFCO05=0.0000
...
#
./nwchem-orbitals-h2.sh  "$FCD00 $FCD01 $FCD11 $FCD05 $FCD51 $FCD55 $RCD00 $RCD01 $RCD11 $RCD05 $RCD51 $RCD55  $FCO00 $FCO01 $FCO11 $FCO05 $FCO51 $FCO55 $RCO00 $RCO01 $RCO11 $RCO05 $RCO51 $RCO55"
./nwchem-orbitals-lih.sh "$FCD00 $FCD01 $FCD11 $FCD05 $FCD51 $FCD55 $RCD00 $RCD01 $RCD11 $RCD05 $RCD51 $RCD55  $FCO00 $FCO01 $FCO11 $FCO05 $FCO51 $FCO55 $RCO00 $RCO01 $RCO11 $RCO05 $RCO51 $RCO55"
...
do
  ...
  ./nwchem-orbitals-h2.sh  "$NEWVAR"
  ./nwchem-orbitals-lih.sh "$NEWVAR"
  parallel -a ./job_list.txt --colsep '\s+' -j ${PBS_NP} "./run_wf.sh {1} {2}"
  ./gather_results.sh
