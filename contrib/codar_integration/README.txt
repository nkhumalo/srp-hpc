...
The integration code can be found in https://github.com/hjjvandam/nwchem-1 on the branch "pretauadio".
...
Code: call sp_wrttrj(lfntrj,lxw,.false.,.false.,lxs,.false.,.false.,
...
Code: adios_comm_world=mpi_comm_world
...
Code: call adios_define_var(m_adios_group, "LWATOMS", "", i2,
     +"", "", "", varid);
...
Code: call adios_open(adios_handle, "coordinates", "nwchem_xyz.bp",
...
Code: if(mdstep.eq.maxstep) then
      adiosrank = me
