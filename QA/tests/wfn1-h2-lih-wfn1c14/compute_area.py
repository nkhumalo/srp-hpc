...
import math
#
f_mcscf=open("results_h2_mc_6_31g.dat")
l_mcscf=f_mcscf.readlines()
f_mcscf.close()
f_mcscf=open("results_h2_mc_sto_3g.dat")
l_mcscf.extend(f_mcscf.readlines())
f_mcscf.close()
f_mcscf=open("results_lih_mc_sto_3g.dat")
l_mcscf.extend(f_mcscf.readlines())
f_mcscf.close()
#
f_wfn1=open("results_h2_wf_6_31g.dat")
l_wfn1=f_wfn1.readlines()
f_wfn1.close()
f_wfn1=open("results_h2_wf_sto_3g.dat")
l_wfn1.extend(f_wfn1.readlines())
f_wfn1.close()
f_wfn1=open("results_lih_wf_sto_3g.dat")
l_wfn1.extend(f_wfn1.readlines())
f_wfn1.close()
#
area=0.0
