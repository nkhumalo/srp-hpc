...
pwd
echo "LS"
ls -l /home/hvandam/nwchem-1/QA/tests/1ai0/1ai0_eq_t01.nw
echo "NWCHEM"
mpiexec -n 16 -x LD_LIBRARY_PATH /home/hvandam/nwchem-1/bin/LINUX64/nwchem /home/hvandam/nwchem-1/QA/tests/1ai0/1ai0_eq_t01.nw 2>&1 > 1ai0_eq_t01.out
